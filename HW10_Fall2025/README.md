...
Please download and unzip the HW10_Fall2025.zip and data.zip from BrightSpace and create a data sub folder. From the course home page on BrightSpace go to
"Content" -> "HW 10".***. Unzip data and paste the contents in the `data` folder you created.
...
Submit your completed version of ONLY `hw10.py`. **DO NOT** upload the dataset you downloaded from brightspace.
